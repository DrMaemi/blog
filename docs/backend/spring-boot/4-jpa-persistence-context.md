...
## 2. 영속성 문맥(Persistence Context)이란?
- **엔티티를 영구 저장하는 환경**
...
<div class="caption">&lt;그림 1. JPA  - 영속성 문맥 - DB 관계&gt;</div>
...
<div class="caption">&lt;그림 2. Entity 생명주기&gt;</div>
...
::: details 엔티티를 정의한 클래스에 `@DynamicUpdate` 선언
```java:no-line-numbers
@Getter
@NoArgsConstructor
@Entity
