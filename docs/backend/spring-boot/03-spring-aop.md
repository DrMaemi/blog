...
<div class="caption">&lt;그림 1. 스프링 AOP 개요&gt;</div>
...
<div class="caption">&lt;그림 2. 프록시 패턴&gt;</div>

- 프록시 패턴의 장점
    - 기존 코드 변경 없이 접근 제어 또는 부가 기능 추가 가능

### 4.1. 프록시 객체 직접 구현 AOP
::: details Client - AppRunner
...
::: details Real Subject - SimpleEventService
```java:no-line-numbers
@Service
