...
<div class="caption">&lt;표 1. 기본형 간 형변환&gt;</div>
...
<div class="align-center">&lt;그림 1. 정수형 간 형변환 - 큰 타입에서 작은 타입으로&gt;</div>
...
<div class="caption">그림 2. 정수형 간 형변환 - 작은 타입에서 큰 타입으로(양수)&gt;</div>
...
<div class="caption">&lt;그림 3. 정수형 간 형변환 - 작은 타입에서 큰 타입으로(음수)&gt;</div>
...
<div class="caption">&lt;그림 4. float를 double로 형변환&gt;</div>
...
<div class="caption">&lt;그림 5. double을 float로 형변환할 때 반올림 발생&gt;</div>
...
<div class="caption">&lt;그림 6. 정수 7이 float타입으로 형변환되는 과정&gt;</div>
...
<div class="caption">&lt;그림 7. 실수 9.1234567이 int타입으로 형변환되는 과정&gt;</div>
...
<div class="caption">&lt;그림 8. 기본형 자동 형변환 가능 방향&gt;</div>
