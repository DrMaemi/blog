...
![](https://drive.google.com/uc?export=view&id=1_BhIgsxTNSGrN2RPuZZDBmdTYPypvLpo)
...
::: details RoadDisplayWithTraffic
```java:no-line-numbers
...
<div class="caption">&lt;표 1. 도로 표시 기능 조합&gt;</div>

## 해결책 - 데코레이터 패턴
조합 수가 늘어나는 문제를 해결하기 위한 설계를 하려면 각 추가 기능별로 개별적인 클래스를 설계하고, 기능을 조합할 때 각 클래스의 객체 조합을 이용합니다.

![](https://drive.google.com/uc?export=view&id=1pvkLu-qCNOlIjKcgjXRB-9cWFBGrKr69)
...
<div class="caption">&lt;그림 3. 순차 다이어그램&gt;</div>
