...
<div class="align-center">&lt;그림 1. 컴퓨팅 계층 구조&gt;</div>
...
<div class="align-center">&lt;그림 2. Stored-program 컴퓨터 아키텍처&gt;</div>
...
<div class="align-center">&lt;그림 3. 현대 컴퓨터 동작 방식&gt;</div>
...
<div class="align-center">&lt;그림 5. SMP 구조&gt;</div>
...
![](https://drive.google.com/uc?export=view&id=1RSlGZgCmhGl5iQHFWWSqAGGBUo3sUNTO)
...
![](https://drive.google.com/uc?export=view&id=1-LksmhzTuerkFuexIM1-8nKfpX_CDwZ4)
&lt;그림 7. 컴퓨터 시스템 동작&gt;
{ .align-center }
...
![](https://drive.google.com/uc?export=view&id=1eQ8VWaZA9fOZ1fOWboWVVyZI7P_zO2-J)
