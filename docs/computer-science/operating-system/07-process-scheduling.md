...
![](https://drive.google.com/uc?export=view&id=1p22CCZUru6xkqepN3WsTHQL9iM-B4Ieb)
&lt;그림 1. 프로세스 실행 특징 - CPU-bound vs IO-bound&gt;
{ .align-center }

![](https://drive.google.com/uc?export=view&id=1h219IifMzdR4hVc-mFfbeuuIBpASXimD)
...
![](https://drive.google.com/uc?export=view&id=1VBRL0FPgR3VRtsmgmDO6Zk03aS7XCBm2)
...
<div class="align-center">&lt;그림 4. Scheduling points&gt;</div>

![](https://drive.google.com/uc?export=view&id=1GM6EDcNwkkzy3DAO-FPyLcSnum8EF2F-)
&lt;그림 5. 스케줄링 개요&gt;
{ .align-center }
...
스케줄링 알고리즘의 성능을 평가하는 요소로 크게 5가지가 있습니다.
...
<div class="align-center">&lt;표 1. Non-preemptive scheduling vs Preemptive scheduling&gt;</div>
</div>

선점형 스케줄링 정책을 사용할 시 다음과 같은 것들을 고려해야 합니다.
...
![](https://drive.google.com/uc?export=view&id=1mA0SmVzRrTVKRYK1YH1xNg5rCIAnMW-a)
...
![](https://drive.google.com/uc?export=view&id=1Mnv7DmPkm8WU8J9KfdtEgbznI7DHNS-C)
&lt;그림 7. SJF 스케줄링 성능 계산&gt;
{ .align-center }
...
![](https://drive.google.com/uc?export=view&id=1ZNE4MmUTntmi_7gN4JNgd9s-qajQaygQ)
...
![](https://drive.google.com/uc?export=view&id=1-Chjm3R4M8SwpTHQXYWU5Sr5Rig7fOmF)
