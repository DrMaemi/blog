...
![](https://drive.google.com/uc?export=view&id=1HkgT9sZX7_wF3y05_op83fZp36TdR8pk)
...
![](https://drive.google.com/uc?export=view&id=1uBETnFnTMrriEyhWPcslOI81Rt8cqcCt)
&lt;그림 2. 인터넷 네트워크 구조&gt;
{ .align-center }
...
![](https://drive.google.com/uc?export=view&id=1kYOAoGbp9dsz7bnIxMmY5v7ety2_ZnWR)
&lt;그림 3. ISP 계층 구조&gt;
{ .align-center }
...
![](https://drive.google.com/uc?export=view&id=1vHzFLLTbw1N7R10gE6wQX5o2mEAXaUQ_)
...
<div class="caption">&lt;그림 5. Circuit-switching 단점&gt;</div>
...
<div class="caption">&lt;그림 6. FDM vs TDM&gt;</div>
...
<div class="caption">&lt;그림 7. Packet-switching&gt;</div>

결과적으로 Packet-switching 기법이 Circuit-switching 기법보다 더 많은 사용자가 네트워크를 사용할 수 있도록 해준다. 

![](https://drive.google.com/uc?export=view&id=185aLqDOvNm2jiiZD20roZ3Qk9ihQB3VE)
...
![](https://drive.google.com/uc?export=view&id=1bfY7qcSzy5bTVh-pQz4GkVo-6qGwmfTq)
&lt;그림 9. Store & Forward&gt;
{ .align-center }
...
![](https://drive.google.com/uc?export=view&id=1RWcYUHkTFJ4T9kfv30ZwlX--maAaBcXP)
&lt;그림 10. Queueing & Loss&gt;
{ .align-center }
...
<div class="caption">&lt;수식 1. Nodel delay&gt;</div>
...
![](https://drive.google.com/uc?export=view&id=1jYVQslnoJPiptik1K2NouawkKR7ouyP-)
...
<div class="caption">&lt;그림 12. 인터넷 프로토콜 스택(네트워크 계층 구조, OSI 7계층)&gt;</div>
...
![](https://drive.google.com/uc?export=view&id=1Qj0-5O0v20EyFAXHWZ2bAG4xcpCm5hC1)
&lt;그림 13. Encapsulation&gt;
{ .align-center }
