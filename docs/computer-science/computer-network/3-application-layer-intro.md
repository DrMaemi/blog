...
## 1. SW의 네트워크 기능 구현
SW의 네트워크 기능은 Application 계층에서 구현한다. 이 때 다음 사항들을 고려해야 한다.
...
![](https://drive.google.com/uc?export=view&id=1w2bo-DFZot1CMM6cX_a1E-2Jfx0aVkng)
...
![](https://drive.google.com/uc?export=view&id=1XPiYPK2PgVyEVuVM2E-_JDVZ_ofNw7S3)
...
<div class="caption">&lt;그림 3. 클라이언트와 서버의 소켓 동작 순서&gt;</div>
...
## 5. 어플리케이션 특성과 프로토콜
어플리케이션이 사용할 프로토콜을 선택할 때 다음과 같은 특성들을 고려해야 한다.
