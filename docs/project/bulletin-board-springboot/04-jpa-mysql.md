---
title: '[게시판 만들기 - Spring Boot] 04. JPA를 이용해 MySQL 연동'
icon: article
...
<div class="align-center">&lt;그림 1. Applicatoin - JPA - RDB 관계 레이아웃&gt;</div>

## JPA 의존성 추가
`build.gradle` 파일에 <화면 1>처럼 의존성을 추가한다.

![](https://drive.google.com/uc?export=view&id=1748C5TMu-P9iXgBZUxzY-3evTkuS6QwY)
...
프로젝트가 application.properties를 사용할 경우
